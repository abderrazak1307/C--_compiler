...
Boucle : FOR IDF ASSIGN Expression WHILE Expression DO Instruction ENDFOR;
...
Val : PintVal | PfloatVal | '(' Val ')';

Type : Pint | Pfloat | '(' Type ')';
...
int yyerror(char* msg){
    ...
    // or use: printf("SyntaxError, Ln %d, Col %d: %s\n", numLn, numCol-yyleng, msg);
